...
2.  **Generate Rich Model Answers**: For each question, the \`modelAnswer\` MUST contain a comprehensive checklist of 3-4 evaluation points. Each point MUST consist of a title followed by a newline and then a very detailed, multi-sentence explanation. This explanation must be so thorough that it educates a non-technical interviewer on the topic, providing deep context and a benchmark for a high-quality answer. You MUST NOT use the word 'Sample' or any other prefix for the explanation.
