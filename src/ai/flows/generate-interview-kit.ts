...
2.  **Generate Rich Model Answers**: For each question, the \`modelAnswer\` MUST contain a comprehensive checklist of 3-4 evaluation points. Each point must have a title and a very detailed, technically rich, and long-form \`Sample\` of a legitimate answer from a candidate's perspective. The sample must be several sentences long at a minimum, providing deep context and explanation. It must be so thorough that a non-technical interviewer can confidently use it to evaluate the candidate's response.
