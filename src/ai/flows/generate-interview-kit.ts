...
2.  **Generate Rich Model Answers**: For each question, the \`modelAnswer\` MUST contain a comprehensive checklist of 3-4 evaluation points. Each point must have a title and a detailed, technically rich \`Sample\` of a legitimate answer from a candidate's perspective. The sample must be several sentences long, enabling a non-technical interviewer to evaluate the candidate effectively.
