...
Based on your analysis, you will now construct the interview kit. You MUST draw questions from the following strategic question bank. **Crucially, you must personalize these questions by replacing placeholders (e.g., "[Technology from Resume]", "[Project from Resume]") with specific, verifiable details taken directly from the candidate's resume. Use the job description for context on what to probe for, but DO NOT mention it in the questions.** Select a broad mix of the most relevant questions for the determined scenario, including several from each of the general-purpose sections ("Universal Ice-breakers", "Probing for Learning Agility & Growth Mindset", "Cross-cutting Behavioural", and "Domain & Industry Knowledge"), to create a comprehensive list of around 80-90 questions.
