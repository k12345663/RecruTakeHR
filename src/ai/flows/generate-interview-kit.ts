...
const QuestionAnswerPairSchema = z.object({
  ...
  question: z.string().describe("A crisp and concise interview question, ONE or TWO lines at most. It must be designed to validate and probe the depth of skills and experiences claimed on the resume. Instead of justasking if they know a technology, ask them to demonstrate their expertise with specific examples of challenges, architectural decisions, or complex problems they solved. The question must be insightful and highly specific, directly derived from projects or skills mentioned in the Candidate's Unstop Profile and, most importantly, the Resume File. Every detail in the resume is a potential source for a probing question. Do NOT include the candidate's name in the question itself."),
