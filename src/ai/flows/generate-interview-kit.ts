...
2.  **Generate Rich Model Answers**: For each question, the \`modelAnswer\` MUST contain a comprehensive checklist of 3-4 evaluation points. For each point, the \`Sample\` must be an explicitly detailed explanation of the point itself, designed to educate a non-technical interviewer. It must provide deep context and explanation, making it a robust benchmark for a high-quality candidate answer. The sample must be several sentences long at a minimum.
