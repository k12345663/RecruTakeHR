...
const QuestionSchema = z.object({
    ...
    question: z.string().describe("The interview question. It must be refined to be crisp and concise, and to validate and probe the depth of skills and experiences claimed on the resume. Instead of just asking if they know a technology, the question should ask them to demonstrate their expertise with specific examples of challenges, architectural decisions, or complex problems they solved. The question must remain insightful and highly specific, directly derived from projects or skills mentioned in the Candidate's Unstop Profile, Resume File, and the Job Description."),
