...
const QuestionSchema = z.object({
    ...
    question: z.string().describe("The interview question. Refine based on user edits while maintaining high quality."),
...
const CustomizeInterviewKitInputSchema = z.object({
    ...
    candidateResumeDataUri: z.string().optional().describe("Original resume data URI for context. AI: This is the data URI of the PDF/DOCX resume file. Analyze its content directly."),
